...
window.addEventListener("load", function(e) {
  ...
  webcam.addEventListener("click", function (e) {
    ...
    console.log( hexcolor + " index value : "+getColorArr("hexs").indexOf(hexcolor));

    console.log("Color :: #"+rgbToHex(color.r,color.g,color.b));
    var n_match  = ntc.name(rgbToHex(color.r,color.g,color.b));
...
// convert the 0 to 255 value into Hex value.
function componentToHex(c) {
    var hex = c.toString(16);
    return hex.length == 1 ? "0" + hex : hex;
}
// convert all the r, g, b values to Hexadecimal value
